#ifndef WEIGHTFILTER_H
#define WEIGHTFILTER_H
#include "weightfilter_global.h"
#include "ifilter.h"

class WEIGHTFILTERSHARED_EXPORT WeightFilter : public QObject, public IFilter
{
    Q_OBJECT
